...
const skills = {
  ...
  "Frameworks": ["Spring Boot", "FastAPI", "React.js", "Node.js", "NestJS", "Express.js"],
  "AI / LLM": ["LLM APIs", "RAG", "Prompt Engineering", "Embeddings"],
  "Cloud & DevOps": ["AWS (S3, EC2, IAM)", "Docker", "Git", "Kafka"],
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {Object.entries(skills).map(([category, items], idx) => (
          <motion.div
            ...
            className="w-full md:w-[calc(50%-1rem)] glass p-8 rounded-2xl border border-white/10 hover:border-primary/30 transition-colors"
          >
